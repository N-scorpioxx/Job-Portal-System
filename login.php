                                ...
                                <div class="col-md-4 col-md-offset-4 well">
                                    ...
                                    <form method="post" action="checklogin.php">
                                        ...
                                        <ul class="list-inline list-inline-sm d-inline-block offset-top-34 post-meta text-dark list-inline-primary">
                                            <li class="list-inline-item"><a href="company-login.php">Want To
                                                    Login As Company?</a></li>
                                        </ul>
                    ...
                    <div class="col-md-8 col-lg-12">
                        <div class="row justify-content-sm-center">
                            ...
                            <div class="col-lg-3 offset-top-50 offset-lg-top-0 order-lg-1">
                                ...
                                <p class="text-dark offset-top-50">Job Portal &copy; <span id="copyright-year"></span>
                                    . <a href="#">Privacy
                                        Policy</a>
                                    <!-- {%FOOTER_LINK}-->
                                </p>
