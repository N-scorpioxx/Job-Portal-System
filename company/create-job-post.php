                        ...
                        <div class="parallax-content">
                            <div class="bg-overlay-gray-darkest">
                                <div class="container section-top-98 section-bottom-34 section-lg-bottom-66 section-lg-98 section-xl-top-155 section-xl-bottom-66">
                                    <div class="text-extra-big font-weight-bold d-none d-lg-block">Create Your Job</div>
                            ...
                            <div class="col-md-4 col-lg-6  col-md-offset-4 well">
                                ...
                                <form method="post" action="addpost.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="minimumsalary" min="1000"
                                            autocomplete="off" name="minimumsalary" placeholder="Minimum Salary"
                                            required="">
                                    </div>
                                    <div class="form-group">
                                        <label for="maximumsalary">Maximum Salary</label>
                                        <input type="number" class="form-control" id="maximumsalary" min="1000" name="maximumsalary"
                                            placeholder="Maximum Salary" required="">
                                    </div>
                                    <div class="form-group">
                                        <label for="experience">Experience (in Years) Required</label>
                                        <input type="number" min="0" class="form-control" id="experience" autocomplete="off"
                                            name="experience" placeholder="Experience Required" required="">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-group" id="qualification" placeholder="Qualification Required"
                                            name="qualification">
