    ...
    <div class="page text-center">
                ...
                <nav class="rd-navbar container rd-navbar-floated rd-navbar-dark rd-navbar-dark-transparent rd-navbar--is-touch rd-navbar-original rd-navbar-static"
                    ...
                    <div class="rd-navbar-inner">
                      ...
                      ?>
                                        ...
                                        <li class="active rd-navbar--has-dropdown rd-navbar-submenu"><a href="#"><span>Pages</span></a><span
                        ...
                        <div class="parallax-content">
                            <div class="bg-overlay-gray-darkest">
                                <div class="container section-top-98 section-bottom-34 section-lg-bottom-66 section-lg-98 section-xl-top-155 section-xl-bottom-66">
                                    <div class="text-extra-big font-weight-bold d-none d-lg-block">Dashboard</div>
        ...
        <main class="page-content">
                ...
                <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="create-job-post.php" class="btn  btn-block btn-primary">Create Job Post</a>
                            </div>
                            <div class="col-md-2">
                                <a href="view-job-post.php" class="btn btn-block btn-primary">View Job Post</a>
                            </div>
                            <?php
          ...
          if($result->num_rows > 0) {
            ?>
                            <div class="col-md-3">
                                <a href="view-job-application.php" class="btn btn-success btn-block btn-lg">View
                                    Application <span class="badge">
                                        <?php echo $result->num_rows; ?></a>
                            </div>
                            <?php
          }
        ?>
