                        ...
                        <div class="parallax-content">
                            <div class="bg-overlay-gray-darkest">
                                <div class="container section-top-98 section-bottom-34 section-lg-bottom-66 section-lg-98 section-xl-top-155 section-xl-bottom-66">
                                    <div class="text-extra-big font-weight-bold d-none d-lg-block">Forgot Password</div>
        ...
        <main class="page-content">
            ...
            <section class="section-98 section-md-110">
              ...
              if(isset($_SESSION['emailNotFoundError'])) {
                ?>
                                        <div>
                                            <p id="successMessage" class="text-center">This Email Not Exists In
                                                Database!</p>
                                        </div>
                                        <?php
              ...
              if(isset($_SESSION['passwordChanged'])) {
                ?>
                                        <div>
                                            <p class="text-center">Check Your Email For New Password. -
